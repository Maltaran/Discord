...
bot.on('message', (message) => {
  ...
  if (message.channel.id == '684473050821034017') {
    ...
    var tracks = {};
    var users = {"qjo0wmnj":{name:"Maltaran",points:0,maps:[]},"o86w6o5x":{name:"kiraa96",points:0,maps:[]},"zx7dqovx":{name:"jeryrep",points:0,maps:[]},"0jmrk1n8":{name:"alexinho.k",points:0,maps:[]},"pj025qw8":{name:"Ikdro",points:0,maps:[]},"pj0kz2r8":{name:"Depresivie",points:0,maps:[]},"81409038":{name:"Oleksik_PL",points:0,maps:[]},"8l0reo78":{name:"TwinTurbo122",points:0,maps:[]},"j5wre7wj":{name:"Hawk0817",points:0,maps:[]},"xz9k6w08":{name:"PlayerOne",points:0,maps:[]},"j96edknj":{name:"Raszta55",points:0,maps:[]},"8qr4erqj":{name:"xKubSon",points:0,maps:[]},"8grg39yx":{name:"uZer",points:0,maps:[]},"j26qnmnx":{name:"MadTrackEnthusiast",points:0,maps:[]},"18q0nq7j":{name:"luigi100",points:0,maps:[]},"jo267w78":{name:"Austinator06302012",points:0,maps:[]},"8enpdr28":{name:"Drzwi_Dembowe",points:0,maps:[]}};
        ...
        fetch('https://www.speedrun.com/api/v1/games/369p8x81/records?top=10&max=200').then(r => r.json()).then(obj => {
          obj.data.forEach(i => {
            if (i.runs.length) {
              ...
              if (cattmp == "59236ord" || cattmp == "29vj8yn9") {base -= 5; mul *= 0.9;} // From the sky, Toygara falls (extremely random, times very close to each other)
